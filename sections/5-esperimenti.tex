...
La figura ~\ref{fig:tempoCore} rappresenta il gragico che è stato costruito sui risultati precedenti: ha sull'asse delle $x$ il numero di core e sull'asse delle $y$ il tempo impiegato per convertire 14400 file. Come si può vedere il tempo impiegato scende in modo quasi lineare per i primi quattro core.
